# Arquitetura do Processador de Ponto VALE (Maquinista)

## Visão Geral

O Processador de Ponto VALE (Maquinista) é uma aplicação web que lê dados brutos de um arquivo de ponto em forma de texto (extraído de PDF) e, após processar, exibe os horários organizados em semanas e meses de forma tabular e pronta para cópia visual. Esta versão é otimizada para maquinistas.
