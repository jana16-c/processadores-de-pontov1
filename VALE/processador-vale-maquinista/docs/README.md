# Documentação do Processador de Ponto VALE (Maquinista)

Bem-vindo à documentação técnica do **Processador de Ponto VALE - Maquinista**. Este projeto é uma aplicação web que processa dados de ponto em PDF e apresenta os horários em formato tabular pronto para cópia no Excel. Esta versão é otimizada para maquinistas.
...
### Para Usuários
1. Abra `indexmaquinista.html` no navegador
...
**Versão**: v1 (processador-vale-maquinista)
