...
/**
 * Constrói e injeta no DOM o HTML final contendo o nome do funcionário, agrupamento por meses e tabelas por semana.
 * @param {string} name - Nome completo do funcionário extraído.
 * @param {Array} timeline - Lista ordenada de objetos com os dias e horários processados.
 * @param {HTMLElement} container - O elemento do DOM (div) onde o resultado gerado será anexado.
 */
